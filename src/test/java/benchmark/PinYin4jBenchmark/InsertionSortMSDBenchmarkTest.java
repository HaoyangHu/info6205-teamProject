...
public class InsertionSortMSDBenchmarkTest {
    @Test
    public void test1(){
        ...
        Benchmark_Timer benchmark_timer = new Benchmark_Timer("test ", null , (t)-> sortWithPinYin4j.InsertionSortMSD.sort(test,0,test.length-1,0), null );
        Benchmark_Timer benchmark_timer1 = new Benchmark_Timer("test1 ", null , (t)-> sortWithPinYin4j.InsertionSortMSD.sort(test1,0,test1.length-1,0), null );
