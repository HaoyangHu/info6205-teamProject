...
public class LSDSortBenchmarkTest {
    @Test
    public void test1(){
        ...
        Benchmark_Timer benchmark_timer = new Benchmark_Timer("test ", null , (t)-> sortWithPinYin4j.LSDsort.sort(test), null );
        Benchmark_Timer benchmark_timer1 = new Benchmark_Timer("test1 ", null , (t)-> sortWithPinYin4j.LSDsort.sort(test1), null );
