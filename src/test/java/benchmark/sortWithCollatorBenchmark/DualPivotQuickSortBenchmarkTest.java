...
public class DualPivotQuickSortBenchmarkTest {
    @Test
    public void test1(){
        String[] test = new String[]{"张三", "李四", "王五", "赵六"};
        String[] test1 = new String[]{"张七", "李八", "王九", "赵十"};

        Benchmark_Timer benchmark_timer = new Benchmark_Timer("test ", null , (t)-> sortWithCollator.DualPivotQuickSort.sort(test), null );
        Benchmark_Timer benchmark_timer1 = new Benchmark_Timer("test1 ", null , (t)-> sortWithCollator.DualPivotQuickSort.sort(test1), null );
