...
public class LSDSortBenchmark {
    ...
    public void test1(){
        ...
        Benchmark_Timer benchmark_timer = new Benchmark_Timer("test ", null , (t)-> sortWithCollator.LSDsort.sort(test), null );
        Benchmark_Timer benchmark_timer1 = new Benchmark_Timer("test1 ", null , (t)-> sortWithCollator.LSDsort.sort(test1), null );
